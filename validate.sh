...
echo $'\nPlease enter the path to your current environment\'s overlays (relative to your Kubernetes manifest directory you just entered): \
i.e., base, prod, dev, overlays/base, overlays/prod, etc.\n\n'
...
mkdir -p .oss_dependencies/.hydrated_manifests/${environment}
